...
- The **custom.config** subsection contains configuration specific to Resurface.
  ...
  - **custom.config.writerequestbodies**: boolean. Controls if request body content is persisted. Set to `false` to disable.
  - **custom.config.writeresponsebodies**: boolean. Controls if response body content is persisted. Set to `false` to disable.
